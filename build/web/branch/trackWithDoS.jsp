        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">
                    ...
                    <form method="GET" action="trackDoS.do" name="trackDoSForm">
                ...
                <div class="fileTrackData" align="center">
                    ...
                    <c:if test="${ not empty requestScope.fileList }">
                        ...
                        <div align="center">
                            ...
                            <h4>
                                Select the "Date-of-send" of the file to track it down...
                            </h4>

                            <table border="1" cellpadding="6" width="60%">
                                <tr>
                                    <th>File ID</th><th>File No</th><th>File Name</th><th>Owner</th><th>DATE-OF-SEND</th><th>CURRENT FILE STATUS</th>
                                </tr>
                                ...
                                <c:forEach var="file" items="${requestScope.fileList}">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a href="trackDoS.do?file_id=${ file.id }"> <c:out value="${ file.dateOfSend }"/> </a></td>
