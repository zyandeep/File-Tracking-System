...
<html>
    ...
    <head>
        ...
        <title>Track File By Name Page</title>

        <link rel="stylesheet" href="/FTS/css/jquery-ui.css">
        <link type="text/css" rel="stylesheet" href="/FTS/css/style.css" />

        <script type="text/javascript" src="/FTS/js/jquery.js"></script>
        <script type="text/javascript" src="/FTS/js/jquery-ui.min.js"></script>
        <script type="text/javascript" src="/FTS/js/branchAjax.js"></script>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">
                    ...
                    <form method="GET" action="trackFileViaName.do" name="trackNameForm">

                        <table cellpadding="5" cellspacing="5">
                            <caption> Track file by Name </caption>
                ...
                <div class="fileTrackData" align="center">
                    ...
                    <c:if test="${ not empty requestScope.fileList }">
                        ...
                        <div align="center">
                            ...
                            <h4>
                                Select the "File Name" of the file to track it down..
                            </h4>
                            ...
                            <table border="1" cellpadding="6" width="60%">
                                ...
                                <c:forEach var="file" items="${requestScope.fileList}">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">  <a href="trackFileViaName.do?file_id=${ file.id }" > <c:out value="${ file.name }"/> </a></td>
