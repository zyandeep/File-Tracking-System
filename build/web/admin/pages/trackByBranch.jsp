...
<html>
    ...
    <head>
        ...
        <title>Track File By Branch Page</title>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">  
                    ...
                    <form method="GET" action="trackByBranch.do" name="trackByBranchForm">

                        <table cellpadding="10" cellspacing="7">
                            <caption> Track file by file Branch </caption>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="branch">
                                        ...
                                        <c:forEach var="branch" items="${ sessionScope.branchNames }">
                            ...
                            <tr>
                                <td> All Incoming Files : &nbsp;&nbsp; </td> 
                                <td>
                                    <input type="checkbox" name="incomingFiles"  />
                                </td>
                            </tr>
                            
                            <tr>
                                <td> All Outgoing Files : &nbsp;&nbsp; </td> 
                                <td>
                                   <input type="checkbox" name="outgoingFiles"  />
                                </td>
                            </tr>
                            
                            <tr>
                                <td> All Registered Files : &nbsp;&nbsp; </td> 
                                <td>
                                  <input type="checkbox" name="createdFiles" />
                                </td>
                            </tr>
                ...
                <div align="center" class="fileTrackData">
                    ...
                    <c:if test="${ not empty requestScope.fileList }">
                        ...
                        <div align="center">
                            ...
                            <h4>
                                Select the "File ID" of the file to track it down...
                            </h4>

                            <table border="1" cellpadding="6" width="60%">
                                <tr>
                                    <th>File ID</th><th>File No</th><th>File Name</th><th>Owner</th><th>CURRENT FILE STATUS</th>
                                </tr>

                                <c:forEach var="file" items="${requestScope.fileList}">

                                    <tr>
                                        <td align="center"><a href="trackByBranch.do?file_id=${ file.id }"> ${ file.id }   </a></td>
