...
<html>
    ...
    <head>
        ...
        <title>Track File By No Page</title>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">
                    ...
                    <form method="GET" action="trackFileViaNo.do" name="trackNoForm">

                        <table cellpadding="5" cellspacing="5">
                            <caption> Track file by No </caption>

                            <tr>
                                <td>Enter the file no: &nbsp;&nbsp; </td> 
                ...
                <div class="fileTrackData" align="center">
                    ...
                    <c:if test="${ not empty requestScope.fileList }">
                        ...
                        <div align="center">
                            ...
                            <h4>
                                Select the "File No" of the file to track it down...
                            </h4>
                            ...
                            <table border="1" cellpadding="6" width="60%">
                                ...
                                <c:forEach var="file" items="${requestScope.fileList}">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"> <a href="trackFileViaNo.do?file_id=${ file.id }"> <c:out value="${ file.no }"/>  </a></td>
