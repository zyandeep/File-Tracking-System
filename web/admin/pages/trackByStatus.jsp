...
<html>
    ...
    <head>
        ...
        <title>Track File By Status Page</title>
    </head>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">  
                    ...
                    <form method="GET" action="trackByStatus.do">

                        <table cellpadding="5" cellspacing="5">
                            <caption> Track file by file status </caption>

                            <tr>
                                <td> Select File Status : &nbsp;&nbsp; </td> 
                                <td>
                                    <select name="status">
                        ...
                        <div align="center">
                            ...
                            <table border="1" cellpadding="6" width="60%">
                                ...
                                <c:forEach var="file" items="${requestScope.fileList}">
                                    ...
                                    <tr>
                                        <td align="center"><a href="trackByStatus.do?file_id=${ file.id }"> ${ file.id }   </a></td>
