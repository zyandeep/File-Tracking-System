...
<html>
    ...
    <head>
        ...
        <title>Track File By Date-of-Send Page</title>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div align="center" class="loginForm">
                    ...
                    <form method="GET" action="trackByDoS.do" name="dateOfSendForm">
                        
                        <table>
                            <caption> Track file by Date-of-send </caption>

                            <tr>
                                <td>Enter the date of send: &nbsp;&nbsp; </td> 
                                <td> <input type="text" name="dos" placeholder="dd-mm-yyyy" /> </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <select name="sender">
                            ...
                            <option selected="selected"> ---- Select the branch ---- </option>
                        ...
                        <div align="center">
                            ...
                            <table border="1" cellpadding="6" width="60%">
                                ...
                                <c:forEach var="file" items="${requestScope.fileList}">
                                    ...
                                    <tr>
                                        <td align="center"><a href="trackByDoS.do?file_id=${ file.id }"> ${ file.id }   </a></td>
